...
# ------------------------- "MAIN" ---------------------
'''# header from netherlands-vpn for the times my IP was blocked
headers = {
...
# categories with subcategories (these are the categories that are skins by definition)
...
# with the following code you can crawl the other items (not skins, but all the other ones: Container, Grafitti, Music Kit, Pass, Patch, Sticker)
